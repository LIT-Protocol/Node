...
use crate::faults::FAULT_TEST_HTTP_CLIENT_TIMEOUT_SECS;
...
use lit_node::config::{
    ...
    CFG_KEY_ENABLE_RATE_LIMITING, CFG_KEY_ENABLE_RATE_LIMITING_ALLOCATION,
...
pub struct CustomNodeRuntimeConfigBuilder {
    ...
    enable_rate_limiting_allocation: Option<String>,
...
impl CustomNodeRuntimeConfigBuilder {
    pub fn new() -> Self {
        Self {
            ...
            enable_rate_limiting_allocation: None,
    ...
    pub fn enable_rate_limiting_allocation(
        mut self,
        enable_rate_limiting_allocation: String,
    ) -> Self {
        self.enable_rate_limiting_allocation = Some(enable_rate_limiting_allocation);
        self
    }
    ...
    pub fn build(self) -> CustomNodeRuntimeConfig {
        CustomNodeRuntimeConfig {
            ...
            enable_rate_limiting_allocation: self.enable_rate_limiting_allocation,
...
pub fn generate_custom_node_runtime_config(
    ...
    cfg.insertstr(
        ...
        &custom_config
            .enable_rate_limiting_allocation
            .clone()
            .unwrap_or("false".into()),
    );
