...
import * as _ethers from "ext:lit/00_ethers.js";
import * as _actions from "ext:lit/02_litActionsSDK.js";
import * as _jwt from "ext:lit/03_jsonwebtoken.js";

// this block scopes oldFetch so that nobody can ever use it after
{
  const oldFetch = globalThis.fetch;
  const fetch = async function () {
    const fetchCount = await Deno[Deno.internal].core.opAsync(
