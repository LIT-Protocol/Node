...
pub struct StytchJWTAuthMethodVerifyer {
    pub factor: Option<String>,
}

#[async_trait::async_trait]
impl AuthMethodVerifier for StytchJWTAuthMethodVerifyer {
...
pub async fn get_auth_key(token: &str) -> error::Result<Value> {
    ...
    match last_retrieved_at {
        Some(at) => {
            ...
            let last_retrieved_at = NaiveDateTime::from_timestamp_opt(last_retrieved_at, 0)
                .expect_or_err("failed to create timestamp opt")?;

            let now = Utc::now();
            let one_hour_ago = now - Duration::hours(CACHE_DURATION_HOURS);
            if last_retrieved_at < one_hour_ago.naive_utc() {
                debug!(
...
pub async fn parse_and_verify_otp_jwt(
    ...
    #[cfg(not(test))]
    {
        ...
        let jwt_exp = NaiveDateTime::from_timestamp_opt(jwt_exp, 0)
            .expect_or_err("failed to create timestamp opt")
            .map_err(|e| unexpected_err(e, None))?;
...
mod tests {
    ...
    use crate::pkp::auth::stytch::StytchJWTAuthMethodVerifyer;

    #[tokio::test]
    async fn should_verify_stytch_no_auth_factor() {
        // token from test project, not used in any production context
        const TEST_TOKEN: &str = "eyJhbGciOiJSUzI1NiIsImtpZCI6Imp3ay10ZXN0LTQ0MmEzYzZkLWI4YWUtNDAwMi05ZDg3LWMwMjY4OGQzZDM1YyIsInR5cCI6IkpXVCJ9..Nj0EmJKHuCOQ-JP9x0i6fEO2tcX08Miurs1ZMsjz531y5bV6ETn6BmBetz4S875rzk32KDBfRJGGXAUqYlaQ-XPRb_gSKJgovy4aErOU8h2rgPDecYVexZMFWHwZQaFUNkTdELJI2pWi-wFcHNaJzXz1ISak_FDiIuJzRhdZK3YcpPea0g2Oxj5l2vV_hH1vT1SGy0nts8cGNJq-eve5_CD0UgwArv8g54jy7MxZtu3fkNQP7ET08DqjlwS-I_BoWSzsFFyDDPuEm0KKJ2eIXf-eIe4ETbTUBNTLUhQJ92ZteEtqtXHMtJi31Od4MT7BaCmlADfry9_Ive7fxW1ztg";
    ...
    async fn should_verify_stytch_email_auth_factor() {
        // token from test project, not used in any production context
        const TEST_TOKEN: &str = "eyJhbGciOiJSUzI1NiIsImtpZCI6Imp3ay10ZXN0LTQ0MmEzYzZkLWI4YWUtNDAwMi05ZDg3LWMwMjY4OGQzZDM1YyIsInR5cCI6IkpXVCJ9..IakQDMISxjICftNGDZyqEbI0jujkHENmOQovn4xUSxehWuLRNkY8bTWwBCifInN1NZ7PH3T-h-Q3-clKxxI0IPnq3anXi4iTJ0j_WykZX-6C4lyUiPbkHhXJXFKQ6hm9AXd8FYxGTfWPs-v8RKovbXbMqW_CvMgB65riseAzSEZAtzdo5lWN44--kv2aDI9m7tok8RhsHWLjz_ktPjS8k4zK128t2tIeWxJRS9Hc2dOFtTmXakrqZMR1zeU6f5q9qvjl87SEbkFc1osDjluqicoYxqBbTI8loLilslNZI1x8W640KFQfAGF4atJn4xjkt7_x5zb0CHoaRaF3oDQIYA";
