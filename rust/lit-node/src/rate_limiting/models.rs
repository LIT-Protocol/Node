...
pub(crate) struct UserContext {
    /// This is the user's IP address.
    pub ip_address: Option<String>,

    /// This is the user's wallet address.
    pub user_address: Option<Address>,

    /// These are the rate limit NFTs that the user is authorized to use.
    pub authorized_rate_limit_nft_ids: Vec<String>,
}
...
pub(crate) struct RateLimitDB {
    ...
    /// Maps wallet address to usage data that was part of the free tier of our rate limiting tiers.
    ///
    /// Could contain not just EVM wallet addresses but also cosmos or solana addresses, hence string type
    /// instead of Address.
    pub free_tier_wallet_usage_map: RwLock<HashMap<String, UsageEntries>>,
    ...
    /// Maps ip address to an associated set of wallet addresses.
    pub ip_to_wallet_addresses_map: Cache<String, HashSet<Address>>,
    ...
    pub fn default_with_chain_data_config_manager(
        ...
        Self {
            ...
            nft_cache: Cache::builder()
                ...
                .build(),
            free_tier_wallet_usage_map: RwLock::new(HashMap::new()),
            nft_usage_map: RwLock::new(HashMap::new()),
            // 24 hour TTL
            ip_to_wallet_addresses_map: Cache::builder()
