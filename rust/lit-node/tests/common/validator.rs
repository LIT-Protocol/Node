...
use crate::common::node_collection::choose_random_indices;
...
impl ValidatorCollection {
    ...
    pub async fn stop_random_node(&mut self) -> Result<usize> {
        let mut rng = crate::common::rand::thread_rng();
...
impl Node {
    ...
    pub fn build_binary(feature_flags: String, node_config_file_path: String) -> Result<String> {
        ...
        let binary_path = format!("./target/debug/lit_node_{}", node_external_port);
        std::fs::copy("./target/debug/lit_node", &binary_path)
