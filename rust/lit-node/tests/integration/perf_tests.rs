...
use common::faults::{get_local_url_from_port, inject_latency_fault, setup_proxies};
...
use crate::integration::ecdsa::{new_node_collection_with_authd_pkp, sign_with_hd_key};
...
pub async fn load_with_no_latency() {
    ...
    node_collection.clear_log_buffers();
    ...
    for i in 0..messages_to_sign {
        ...
        'outer: for lines in node_collection.get_logs() {
            for line in lines {
