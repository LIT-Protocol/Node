...
declare -a NORMAL_CONTRACTS=("LITToken" "PKPNFT" "Allowlist" "HDKeyDeriver" "ContractResolver" "ReleaseRegister" "DomainWalletOracle" "DomainWalletRegistry" "Multisender" "PKPNFTMetadata" "PKPHelper" "WLIT")
