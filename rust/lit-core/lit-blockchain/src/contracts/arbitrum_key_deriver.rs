...
pub mod arbitrum_key_deriver {
    ...
    impl ::ethers::core::abi::AbiDecode for ArbitrumKeyDeriverCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <HdKdfK256Call as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::HdKdfK256(decoded));
            }
            if let Ok(decoded)
                = <HdKdfP256Call as ::ethers::core::abi::AbiDecode>::decode(data) {
