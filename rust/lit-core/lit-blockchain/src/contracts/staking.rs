...
pub mod staking {
    ...
    impl<M: ::ethers::providers::Middleware> Staking<M> {
        ...
        ///Calls the contract's `setConfig` (0x5c45a8d5) function
        pub fn set_config(
            &self,
            new_token_reward_per_token_per_epoch: ::ethers::core::types::U256,
            new_complaint_tolerance: ::ethers::core::types::U256,
            new_complaint_interval_secs: ::ethers::core::types::U256,
            new_key_types: ::std::vec::Vec<::ethers::core::types::U256>,
            new_minimum_validator_count: ::ethers::core::types::U256,
            new_max_concurrent_requests: ::ethers::core::types::U256,
            new_max_triple_count: ::ethers::core::types::U256,
            new_min_triple_count: ::ethers::core::types::U256,
            new_peer_checking_interval_secs: ::ethers::core::types::U256,
            new_max_triple_concurrency: ::ethers::core::types::U256,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash(
                    [92, 69, 168, 213],
                    (
                        new_token_reward_per_token_per_epoch,
                        new_complaint_tolerance,
                        new_complaint_interval_secs,
                        new_key_types,
                        new_minimum_validator_count,
                        new_max_concurrent_requests,
                        new_max_triple_count,
                        new_min_triple_count,
                        new_peer_checking_interval_secs,
                        new_max_triple_concurrency,
                    ),
                )
                .expect("method not found (this should never happen)")
        }
    ...
    #[ethevent(
        name = "ConfigSet",
        abi = "ConfigSet(uint256,uint256,uint256,uint256[],uint256,uint256,uint256,uint256,uint256,uint256)"
    )]
    pub struct ConfigSetFilter {
        pub new_token_reward_per_token_per_epoch: ::ethers::core::types::U256,
        pub new_complaint_tolerance: ::ethers::core::types::U256,
        pub new_complaint_interval_secs: ::ethers::core::types::U256,
    ...
    ///Container type for all input parameters for the `setConfig` function with signature `setConfig(uint256,uint256,uint256,uint256[],uint256,uint256,uint256,uint256,uint256,uint256)` and selector `0x5c45a8d5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "setConfig",
        abi = "setConfig(uint256,uint256,uint256,uint256[],uint256,uint256,uint256,uint256,uint256,uint256)"
    )]
    ...
    ///`Config(uint256,uint256,uint256,uint256[],uint256,uint256,uint256,uint256,uint256,uint256)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct Config {
        ...
        pub complaint_tolerance: ::ethers::core::types::U256,
        pub complaint_interval_secs: ::ethers::core::types::U256,
