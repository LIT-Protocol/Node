...
const VERIFY_PATHS_ROOT: [&str; 7] = [
    "/etc/lit/config.toml", "/etc/lit-os-build", "/etc/ssl/certs/build.pem",
    "/usr/share/ca-certificates/mozilla", "/usr/bin/sev-guest-get-report",
    "/usr/bin/sev-guest-parse-report", "/usr/bin/sev-guest-kdf",
];
