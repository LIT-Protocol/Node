...
export interface DeployNodeConfig extends DeployBaseConfig {
    ...
    numberOfNodeWallets: number;
    numberOfStakedWallets: number;
...
export interface ParsedDomainWalletContracts {
    domainWalletOracleAddress: string;
    domainWalletRegistryAddress: string;
}

export interface ParsedNodeContracts {
    ...
    resolverContractAddress: string;
    domainWalletOracle: string;
    domainWalletRegistry: string;
    chainId: number;
    rpcUrl: string;
    chainName: string;
