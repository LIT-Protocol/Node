...
contract StakingFacet {
    ...
    function kickValidatorInNextEpoch(
        ...
        if (
            ...
            // slash the stake
            uint256 kickPenaltyPercent = s().kickPenaltyPercentByReason[reason];
    ...
    function setKickPenaltyPercent(
        ...
        s().kickPenaltyPercentByReason[reason] = newKickPenaltyPercent;
    ...
    function setConfig(
        ...
        require(
            newMinTripleCount <= newMaxTripleCount,
        ...
        mutableConfig().complaintTolerance = newComplaintTolerance;
        mutableConfig().complaintIntervalSecs = newComplaintIntervalSecs;
        mutableConfig().keyTypes = newKeyTypes;
        mutableConfig().minimumValidatorCount = newMinimumValidatorCount;
        mutableConfig().maxConcurrentRequests = newMaxConcurrentRequests;
        mutableConfig().maxTripleCount = newMaxTripleCount;
        mutableConfig().minTripleCount = newMinTripleCount;
        mutableConfig().peerCheckingIntervalSecs = newPeerCheckingIntervalSecs;
        mutableConfig().maxTripleConcurrency = newMaxTripleConcurrency;
        emit ConfigSet(
