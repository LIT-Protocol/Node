        ...
        context("when routing data is unset", async () => {
            ...
            it("retrieves empty routing data", async () => {
                ...
                const [pubkey, stakingContract, keyType] =
                    await router.getRoutingData(pubkeyHash);
            ...
            context(
                ...
                async function () {
                    ...
                    before(async () => {
                        ...
                        let params = await getParamsFromPKPMint(
                            tx,
                            pkpContract
                        );
                    ...
                    it("checks the PKP eth address and the reverse mapping", async () => {
                        ...
                        const pubkeyFromContract = await router.getPubkey(
                            tokenId
                        );
                        let ethAddressOfPKP = await router.getEthAddress(
                            tokenId
                        );
                        ...
                        const tokenIdFromContract =
                            await router.ethAddressToPkpId(ethAddressOfPKP);
